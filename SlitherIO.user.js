// ==UserScript==
// @name        Slither.io Invincible HackBot (Best Slither Bot and working 2019)
// @namespace   RoggyBot
// @description Slither.io Invincible HackBot by CTHack and Fixed by RoggyBot
// @include     http://slither.io/*
// @version     1.0.1
// @grant       none
// ==/UserScript==
var _0x133a=[""];alert(_0x133a[0])
window.log = function() {
...
window.initBot = function() {
    ...
    window.nick.value = window.loadPreference('savedNick', 'nick!');
    // Overlays
    // Top left
    ...
    // Start!
    window.launchBot(50);
    window.startInterval = setInterval(window.startBot, 1000);//possible will remove becuase this could cause great lag
};
window.initBot();
